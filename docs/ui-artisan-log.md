...
- `harbor-hero.png` is zoomed into the watercolor (boats, lighthouse, sunset runes) so the baked-in gold frame and parchment mat are cropped out of the viewport (`215vmax`, `195vmax` under 720px).
