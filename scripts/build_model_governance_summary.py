...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--weekly-review", type=Path, default=Path("web/data/diagnostics/weekly_alpha_review_latest.json"))
    parser.add_argument("--mart-sync", type=Path, default=Path("web/data/diagnostics/shared_mart_sync_latest.json"))
...
def main() -> int:
    ...
    report = build_model_governance_summary(
        ...
        weekly_review=_load(args.weekly_review),
