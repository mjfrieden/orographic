...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build paired prospective evidence for the payoff challenger.")
    parser.add_argument(
        "--ledger",
        type=Path,
    ...
    artifact = write_payoff_challenger_evidence(args.ledger, args.output)
